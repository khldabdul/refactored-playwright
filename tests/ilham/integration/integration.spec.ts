...
test.describe('Ilham - Integration Configuration', { 
  tag: ['@ilham', '@integration', '@configuration'] 
}, () => {
  
  test('Setup basic API integration', { 
    tag: ['@smoke', '@p1'] 
  ...
  test('Setup basic auth integration', { 
    tag: ['@regression', '@p2'] 
  }, async ({ pageObject }) => {
    await pageObject.IlhamIntegrationPage.navigate();
  ...
  test('Test invalid API configuration', { 
  ...
  test('Reset integration configuration', { 
    tag: ['@regression', '@p3'] 
  }, async ({ pageObject }) => {
    await pageObject.IlhamIntegrationPage.navigate();
