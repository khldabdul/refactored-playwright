...
export class IlhamIntegrationPage {
  ...
  // Integration form
  readonly integrationForm = $('form[data-testid="integration-form"], .integration-form').with({
    // API Configuration section
    apiSection: $('.api-section, [data-testid="api-section"]').with({
      ...
      async fillApiConfiguration(config: { url: string; apiKey: string; apiSecret: string; timeout?: string }) {
    ...
    authSection: $('.auth-section, [data-testid="auth-section"]').with({
    ...
    // Settings section
    settingsSection: $('.settings-section, [data-testid="settings-section"]').with({
  ...
  readonly statusPanel = $('.status-panel, [data-testid="status-panel"]').with({
