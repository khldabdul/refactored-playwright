...
export class MSSdashboardPage {
  ...
  // Navigation sidebar
  readonly sidebar = $('.sidebar, .nav-sidebar, [data-testid="sidebar"]').with({
  ...
  // Dashboard widgets
  readonly widgets = $('.dashboard-widgets, [data-testid="widgets"]').with({
    statsWidget: $('.stats-widget, [data-testid="stats-widget"]').with({
    ...
    chartWidget: $('.chart-widget, [data-testid="chart-widget"]').with({
    ...
    recentActivityWidget: $('.activity-widget, [data-testid="recent-activity"]').with({
