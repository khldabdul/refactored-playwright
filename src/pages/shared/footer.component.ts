...
export const FooterComponent = $('.footer, [data-testid="footer"]')
  .with({
    // Footer sections
    companyInfo: $('.company-info, [data-testid="company-info"]')
      .with({
    ...
    quickLinks: $('.quick-links, [data-testid="quick-links"]')
      .with({
    ...
    socialMedia: $('.social-media, [data-testid="social-media"]')
      .with({
    ...
    newsletter: $('.newsletter, [data-testid="newsletter"]')
      .with({
    ...
    languageSelector: $('.language-selector, [data-testid="language-selector"]')
      .with({
